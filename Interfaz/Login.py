from PyQt6.QtWidgets import QWidget, QPushButton, QLineEdit, QLabel, QCheckBox, QMessageBox
...
class Login(QWidget):
    ...
    #Mostrar u ocultar la contraseña al hacer click en el checkbox
    ...
    def verificar(self):
       # Implementar la lógica de verificación del gerente aquí
       pass
    

    # La misma función de volver que en las otras ventanas
